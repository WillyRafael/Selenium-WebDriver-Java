...
public abstract class BasePage {
    ...
    public Boolean areAllDisplayed(List locators) {
    ...
    public void updateElementText(By locator, String newText) {
        waitVisibilityOfElementLocated(locator);
        clear(locator);
        driver.findElement(locator).sendKeys(newText, Keys.ENTER);
    }

    public boolean waitForTextToBePresent(By locator, String expectedText, Duration duration) {
        WebDriverWait localWait = new WebDriverWait(driver, duration);
        return localWait.until(ExpectedConditions.textToBePresentInElementLocated(locator, expectedText));
    }
    
    public void waitForElementStaleness(By locator, Duration duration) {
        WebElement element = driver.findElement(locator);
        new WebDriverWait(driver, duration).until(ExpectedConditions.stalenessOf(element));
    }

    public String getCanvasDataUrl(String canvasId) {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        return (String) js.executeScript("return document.getElementById('" + canvasId + "').toDataURL();");
    }

    public void movePageAndClick(By locator) {
        WebElement createAccountButton = driver.findElement(locator);
